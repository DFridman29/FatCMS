...
*/
    ...
    $lang['firesale:settings_dashboard_inst']               = 'Show the Store dashboard instead of the default';
    ...
    // Install errors
    $lang['firesale:install:wrong_version']                 = 'Unable to install the Store module, Store requires FatCMS v2.1.5 or above';
    $lang['firesale:install:missing_multiple']              = 'Store requires the Multiple Relationships field type to operate. You can download this from <a href="https://github.com/adamfairholm/PyroStreams-Multiple-Relationships/zipball/2.0/develop">here</a>';
    $lang['firesale:install:not_installed']                 = 'Please install the Store module before installing additional Store add-ons';
    $lang['firesale:install:no_route_access']               = 'Store requires access to the system/cms/config/routes.php file. Please set the appropriate permissions and try again';
    $lang['firesale:install:old_multiple']                  = 'Your currently installed version of the Multiple field type is out of date, please delete or upgrade it before attempting to use Store';
