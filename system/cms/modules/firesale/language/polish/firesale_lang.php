...
*/
    ...
    // Install errors
    $lang['firesale:install:wrong_version']    = 'Nie można zainstalować modułu Store; Store wymaga FatCMS v2.1.5 lub wyżej';
    $lang['firesale:install:missing_multiple'] = 'Store wymaga the Multiple Relationships field type do działania. Możesz to pobrać <a href="https://github.com/adamfairholm/PyroStreams-Multiple-Relationships/zipball/2.0/develop">stąd</a>';
    $lang['firesale:install:not_installed']    = 'Proszę zainstalować moduł Store przed instalacją dodatków Store';
    $lang['firesale:install:no_route_access']  = 'Store wymaga dostępu do  system/cms/config/routes.php file. Ustaw prawa dostępu i spróbuj ponownie';
