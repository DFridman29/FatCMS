...
*/
    ...
    // Install errors
    $lang['firesale:install:wrong_version']    = 'Non è possibile installare il modulo Store, Store richiede FatCMS v2.1.4 o superiore';
    $lang['firesale:install:missing_multiple'] = 'Store richiede Multiple Relationships field type per funzionare. Puoi scaricarlo da <a target="_blank" href="https://github.com/adamfairholm/PyroStreams-Multiple-Relationships/zipball/2.0/develop">qui</a>';
    $lang['firesale:install:not_installed']    = 'Per favore installa prima il modulo Store e poi i suoi addons';
    $lang['firesale:install:no_route_access']  = 'Store richiede l\'accesso al file system/cms/config/routes.php. Per favore imposta i permessi appropriati e riprova';
