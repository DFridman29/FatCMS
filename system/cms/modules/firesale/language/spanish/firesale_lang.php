...
*/
    ...
    $lang['firesale:settings_dashboard_inst']        = 'Muestra el Panel de Store en vez del predeterminado';
    ...
    // Install errors
    $lang['firesale:install:wrong_version']    = 'No se puede instalar el módulo firesale, Store requiere FatCMS v2.1.5 or superior';
    $lang['firesale:install:missing_multiple'] = 'Store requiere: Multiple Relationships field type para funcionar. Obtenerlo <a href="https://github.com/adamfairholm/PyroStreams-Multiple-Relationships/zipball/2.0/develop">aquí.</a>';
    $lang['firesale:install:not_installed']    = 'Installe primero el Modulo de Firesale antes que los plugins.';
    $lang['firesale:install:no_route_access']  = 'Store requiere acceso al archivo: system/cms/config/routes.php. Asegurese de tener permisos de escritura y trate de nuevo.';
