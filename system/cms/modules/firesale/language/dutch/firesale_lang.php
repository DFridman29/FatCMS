...
*/
    ...
    $lang['firesale:settings_dashboard_inst']        		= 'Toon het Store dashboard inplaats van de standaard';
    ...
    // Install errors
    $lang['firesale:install:wrong_version']                 = 'Kan de Store module niet installeren, Store heeft FatCMS v2.1.5 of hoger nodig';
    $lang['firesale:install:missing_multiple']              = 'Store heeft de Multiple Relationships veld type om te werken. U kunt deze downloaden van <a href="https://github.com/adamfairholm/PyroStreams-Multiple-Relationships/zipball/2.0/develop">Hier</a>';
    $lang['firesale:install:not_installed']                 = 'Installeer eerst de Store module voor dat u de overige modules installeerd';
    $lang['firesale:install:no_route_access']               = 'Store heeft toegang tot system/cms/config/routes.php bestand nodig. Controlleer of het bestand beschrijfbaar is en probeer het opnieuw';
