...
class Module_Firesale extends Module
{
    ...
    public function info()
    {
        ...
        $info = array(
            ...
            'description' => array(
                'en' => 'The lightweight & extensible eCommerce platform for FatCMS',
                'br' => 'The lightweight & extensible eCommerce platform for FatCMS', # translate
                'fr' => 'Plateforme eCommerce pour FatCMS',
                'id' => 'The lightweight & extensible eCommerce platform for FatCMS', # translate
                'it' => 'Una leggera piattaforma eCommerce per FatCMS',
                'lt' => 'The lightweight & extensible eCommerce platform for FatCMS', # translate
                'pl' => 'Lekka i elastyczna platforma eCommerce dla FatCMS',
                'es' => 'The lightweight & extensible eCommerce platform for FatCMS'  # translate
            ),
            'frontend' => TRUE,
            'backend'  => TRUE,
            'author'   => 'Moltin Ltd',
